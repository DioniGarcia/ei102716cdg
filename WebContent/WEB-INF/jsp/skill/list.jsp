	    ...
	    <div class="page-content">
			...
			<table class="mdl-data-table mdl-js-data-table">
				...
				<c:forEach items="${skills}" var="skill">
					<tr>
						<td class="mdl-data-table__cell--non-numeric">${skill.id }</td>
						<td class="mdl-data-table__cell--non-numeric">${skill.name }</td>
						<td class="mdl-data-table__cell--non-numeric">${skill.description }</td>
						<td class="mdl-data-table__cell--non-numeric">${skill.level }</td>
						<td class="mdl-data-table__cell--non-numeric">${skill.status }</td>
						<td>
							<a style="display:inline-block;" href="update/${ skill.id }.html">
								<i class="material-icons">mode_edit</i>
							</a>
							<a style="display:inline-block;" href="delete/${ skill.id }.html">
